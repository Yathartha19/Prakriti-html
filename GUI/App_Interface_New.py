...
"""# Import the PyObjC module
import objc

# Load the Objective-C delegate class
objc.loadBundle("AppDelegate", AppDelegate, bundle_path="./")


# Import the PyObjC module
import objc

# Define the Objective-C delegate class directly
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #MainWindow.setWindowFlags(QtCore.Qt.FramelessWindowHint)   ---  ERROR HAS BEEN RECTIFIED
        #MainWindow.setAttribute(QtCore.Qt.WA_TranslucentBackground)   ---  ERROR HAS BEEN RECTIFIED
        MainWindow.setWindowFlags(QtCore.Qt.WindowType.FramelessWindowHint)
        #MainWindow.setAttribute(QtCore.Qt.WA_TranslucentBackground)   ---  ERROR HAS BEEN RECTIFIED
        #MainWindow.setAttribute(QtCore.WidgetAttribute.WA_Translucentbackground)   ---  ERROR HAS BEEN RECTIFIED
        #MainWindow.setFlag(Qt.WindowFlag.FramelessWindowHint)   ---  ERROR HAS BEEN RECTIFIED
        #MainWindow.setFlag(Qt.WindowFlag.FramelessWindowHint)   ---  ERROR HAS BEEN RECTIFIED
...
"")
        ...
        #self.label_4.setAlignment(Qt.AlignCenter)   ---  ERROR HAS BEEN RECTIFIED
...
"")
        ...
        self.label_7.setGeometry(QRect(70, 480, 421, 40))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        #self.pushButton.clicked.connect(subprocess.call("python AQI_Interface_Part1.py 1", shell = True))
        
    def con_aqi(self):
        p = subprocess.call("python3 AQI_Interface_Part1.py 1", shell = True)
        

    def con_wqi(self):
        p = subprocess.call("python3 WQI_Interface.py 1", shell = True)

    def con_menu(self):
        p = subprocess.call("python3 Menu_Interface.py 1", shell = True)
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindow()
    # Create an instance of the Objective-C delegate class
    """ delegate = AppDelegate.alloc().init() 
    # Set the delegate for the application
    app.setApplicationDelegate(delegate)"""
